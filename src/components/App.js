...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "nextQuestion":
      const correctAnswers = state.questions.map(
      ...
      return {
        ...
        index: state.index + 1,
        answer:
          state.status === "review" ? correctAnswers.at(state.index + 1) : null,
      };
    case "finish":
      return {
        ...state,
    ...
    case "review":
      const answers = state.questions.map((question) => question.correctOption);
      return {
        ...state,
        status: "review",
        index: 0,
